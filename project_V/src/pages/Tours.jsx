        ...
        <div className='container'>
            <div className="main_block">
                <div className="blocks">
                    ...
                    <p className='signature'>Незабываемое путешествие по Башкирии, прогулки по коралловым
                ...
                <div className="blocks">
                    ...
                    <p className='signature'>Насыщенный и комфортный тур с посещением заповедников, храмов и музеев,
                ...
                <div className="blocks">
                    ...
                    <p className='signature'>Активный тур с 2 восхождениями и 3 нац.парками! Пройдём живописными горными 
            ...
            <div className="main2_block">
                <div className="blocks">
                    ...
                    <p className='signature'>Налегке гуляем по заповедникам, наслаждаемся тишиной в волшебном зимнем лесу, 
                ...
                <div className="blocks">
                    ...
                    <p className='signature'>Едем в башкирские сёла и заповедники за национальным колоритом: ночуем
                ...
                <div className="blocks">
                    ...
                    <Link to="/" className='reminder'><h3 className='rem'>Сообщить о появлении новых дат</h3></Link>
                    <p className='signature'>Нас ждут треккинги по трём знаменитым национальным паркам, восхождение на
