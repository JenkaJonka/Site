    ...
    <>
      ...
      <div className="wrapper">
        ...
        <div className='inform'>
          ...
          <span class="description2">Это замечательное путешествие. Полная перезагрузка! Единение с природой, красотой невозможно было насладиться, не хотелось останавливаться.
            Все маршруты были прекрасны и уникальны по своему. Спасибо большое за незабываемые эмоции!</span>
        </div>
      </div>
