  ...
  return (
    <>
      ...
      <div className='content'>
        <p>У нас действует система&nbsp;<strong>&laquo;Безопасное бронирование&raquo;:</strong> предоплата за тур всего 10%
          и отмена брони без штрафа. Если до путешествия осталось менее 90 дней, то предоплата составит 30%.</p>
        <p>
          <strong>Если позже вы решите не ехать &mdash; мы вернём оплату полностью в течение 3 рабочих дней.</strong></p>
        <p>
          Вы без рисков можете забронировать путешествие на любые открытые даты. Если направление будет закрыто
          из-за эпидемиологической ситуации или вы просто передумаете &mdash; мы вернём вам все деньги.</p>
      </div>
      ...
      <div className='content'>
        ...
        Можно будет поехать в более поздние сроки или выбрать любое другое путешествие нашего Клуба, а также перенести внесенную вами
        сумму на бессрочный депозит в ООО&nbsp;&laquo;Клуб Путник&raquo;, который гарантирует право:&nbsp;
        <p>
